...
def main():
    ...
    result = agent.run("""I need to create a template for managing research papers in our academic database.
    ...
    result = agent.run("""Create a template called 'Job Application' for tracking job applications.
    ...
    result = agent.run("""Show me all entities from the 'Blog Post' template.
    ...
    result = agent.run("""I'm building a recipe management system for a cooking blog.
